...
char noTeams[] = "There are no teams created.";
char inLeague[] = "In league:";
char noTrades[] = "You have not created trades yet.";
...
char playerChooseSuccessful[] = "Your player was successfully chosen.";
char isYourTurn[] = "Is your turn to choose!.";
char draftStarting[] = "Draft is starting.";
char draftEnded[] = "Draft has ended.";
char loggedOut[] = "Logged out.";
char isNotYourTrade[] = "Is not your trade";
char endedTrade[] = "You cannot cancel this trade, it has already been answered.";
