...
#define IS_REMOVABLE(D) 	kprintf("Is %sremovable\n", (D & BIT(7)) ? "" : "not ")
#define IS_ATA_DRIVE(D) 	kprintf("Is %sATA\n", (D & BIT(15)) ? "not " : "")
#define DMA_SUP(D) 			kprintf("DMA is %ssupported\n", (D & BIT(8)) ? "" : "not ")
#define LBA_SUP(D) 			kprintf("LBA is %ssupported\n", (D & BIT(9)) ? "" : "not")
#define DMA_QUEUED_SUP(D) 	kprintf("DMA QUEUED supported\n", (D & BIT(1)) ? "" : "not ")
